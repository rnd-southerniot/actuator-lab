...
| **REV Core Hex Motor** (REV-41-1300) | Brushed DC gearmotor (72:1) + encoder | PWM H-bridge (MC33886) | STM32 Discovery | ⏳ partial (P0–4 ✅: motion + 288 cnt/rev cal; P5 low-speed ✅, mid/high ⚠️ supply-limited) | [actuators/rev-core-hex-motor](actuators/rev-core-hex-motor) |

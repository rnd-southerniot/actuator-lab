...
| **MG513 / GMR** ×2 (500 PPR, 30:1) | **Dual** brushed DC gearmotor + GMR quad encoders | DBH-12V dual H-bridge (20 kHz) | STM32 NUCLEO-F401RE | ✅ **dual-axis validated** — both motors: closed-loop RPM (ss_err<0.5), position (±0.1°), repeatability (0° drift), current sense + overcurrent, stall detect, E-STOP. Wiring per auro-balancer map (A: PC10/PC3, B: PC11/PC4). Firmware = submodule `stm32-nucleo-gmr-encoder` @ `feat/dual-axis-motor-b` | [actuators/mg513-gmr-nucleo-f401](actuators/mg513-gmr-nucleo-f401) |

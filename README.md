...
| **MG513P30** 12V (Hall encoder) | Brushed DC gearmotor (30:1) + Hall quad encoder | PWM H-bridge (MC33886) | STM32 Discovery | ⏳ partial (P0–3 ✅: motor+encoder+both dirs; closed-loop vel stable; 1560 cnt/rev). P4–7 pending | [actuators/mg513p30-hall-motor](actuators/mg513p30-hall-motor) |

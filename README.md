...
| **MG513 / GMR** (500 PPR, 30:1) | Brushed DC gearmotor + GMR quad encoder | DBH-12V H-bridge (20 kHz) | STM32 NUCLEO-F401RE | ⏳ onboarding — P1 comms ✅ (per src repo); wiring/motion pending. Firmware = submodule `stm32-nucleo-gmr-encoder` | [actuators/mg513-gmr-nucleo-f401](actuators/mg513-gmr-nucleo-f401) |

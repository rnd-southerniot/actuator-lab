...
| **MG513 / GMR** ×2 (500 PPR, 30:1) | **Dual** brushed DC gearmotor + GMR quad encoders | DBH-12V dual H-bridge (20 kHz) | STM32 NUCLEO-F401RE | ✅ **dual-axis** — Axis A P0–7 (RPM ss_err<0.5, position ±0°, repeat 0° drift, stall/E-STOP), Axis B P2–7 (encoder, dir-fix, RPM ss_err 0, ±0.1° position, 0° drift, stall/E-STOP). Overcurrent pending (CT wiring). Firmware = submodule `stm32-nucleo-gmr-encoder` @ dual-axis | [actuators/mg513-gmr-nucleo-f401](actuators/mg513-gmr-nucleo-f401) |

...
| **MG513P30** 12V (Hall encoder) | Brushed DC gearmotor (30:1) + Hall quad encoder | PWM H-bridge (MC33886) | STM32 Discovery | ⛔ onboarding — folder scaffolded; specs pending confirm (encoder PPR/VCC); reuses REV rig + firmware | [actuators/mg513p30-hall-motor](actuators/mg513p30-hall-motor) |

...
| **MG513P30** 12V (Hall encoder) | Brushed DC gearmotor (30:1) + Hall quad encoder | PWM H-bridge (MC33886) | STM32 Discovery | ⏳ partial (P0–4 ✅: motion; closed-loop vel; **cal 1456 cnt/rev — gearbox ~28:1 not 30**). P5–7 pending | [actuators/mg513p30-hall-motor](actuators/mg513p30-hall-motor) |

...
| **MG513 / GMR** (500 PPR, 30:1) | Brushed DC gearmotor + GMR quad encoder | DBH-12V H-bridge (20 kHz) | STM32 NUCLEO-F401RE | ⏳ P0–4 ✅ (comms, encoder, open-loop + direction fix, closed-loop RPM kp0.0015/ki0.01 ss_err<0.5rpm, band 0–200). P5–7 pending. 3 local FW fixes (dir, UART-ORE wedge, baked gains). Firmware = submodule `stm32-nucleo-gmr-encoder` | [actuators/mg513-gmr-nucleo-f401](actuators/mg513-gmr-nucleo-f401) |
